          ...
          <div className="flex justify-between items-center h-16">
            ...
            {isAuthenticated ? (
              ...
              <button
                ...
                className="px-6 py-2.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/60 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all duration-200 active:scale-[0.98]"
              >
                Login
              </button>
            )}
