                ...
                {isRegisterMode && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-slate-700/40 border border-slate-600/40 rounded-xl text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-4 focus:ring-blue-500/25 focus:border-blue-500/60 transition-all duration-200 shadow-inner"
                      required
                      disabled={loading}
                    />
                  </div>
